...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(
        ...
        match = refullmatch(
                pattern, authorization_header.strip()
                )
        #  match = re.fullmatch(r'Basic (?P<token>.+)',
        # authorization_header.strip())
        # line 37-38 above should be 1 line yet to long hence 33 - 37
    ...
    def extract_user_credentials(
        ...
        """Extract user credentials from a base64-decoded authorization header.
        ...
        # Line 80-82 above should be 1 line yet to long hence code line 76-79
        if match:
